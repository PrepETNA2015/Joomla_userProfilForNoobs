...
class PlgUserProfile extends JPlugin
{
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		$fields = get_object_vars(simplexml_load_file(__DIR__.'/fields.xml'));
		$fields = $fields['field'];
		//var_dump($fields);
		...
		if ($app->isSite())
		{
			for ($i = 0; $i < count($fields) - 1; $i++) {
				$form->setFieldAttribute($fields[$i], 'description', 'PLG_USER_PROFILE_FILL_FIELD_DESC_SITE', 'profile');
			}
